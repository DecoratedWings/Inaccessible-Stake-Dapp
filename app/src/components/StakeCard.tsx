...
function StakeCard(props: stakeCardProps) {
  ...
  return (
    ...
    >
      <SuccessPopup show={show} setShow={setShow} msg={"Successfully Executed Transaction!"}/>
      ...
      <Card.Body>
        ...
        />
        <Button variant="secondary" onClick={()=>sendStakeRequest()}>Stake</Button>{" "}    &nbsp;
        <Button variant="secondary" onClick={()=>sendUnstakeRequest()}>Unstake</Button>{" "}
      </InputGroup>
